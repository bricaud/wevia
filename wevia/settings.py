"""
Django settings for wevia project.
...
SECRET_KEY = 'a22rd-wlh&)yh@64+6i*b0+aepd=*9mhgtu%p@$ot6qx$pr__q'
...
ROOT_URLCONF = 'wevia.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['wevia/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'wevia.wsgi.application'
